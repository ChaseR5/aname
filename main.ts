...
controller.left.onEvent(ControllerButtonEvent.Pressed, function () {
    Player1.startEffect(effects.fire)
})
...
sprites.onOverlap(SpriteKind.player2, SpriteKind.Enemy, function (sprite2, otherSprite2) {
...
Player2 = sprites.create(img`
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.player2)
Player1.setPosition(0, 60)
Player2.setPosition(0, 45)
...
scene.setBackgroundImage(img`
    ...
    ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    `)
_3.changeScale(10, ScaleAnchor.Bottom)
_2.changeScale(10, ScaleAnchor.Bottom)
_1.changeScale(10, ScaleAnchor.Bottom)
...
forever(function () {
    ...
    if (_2.overlapsWith(Walls)) {
        _3.setPosition(77, 90)
    }
    if (_3.overlapsWith(Walls)) {
